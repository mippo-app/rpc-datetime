...
pub mod holiday_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn is_holiday(
            &mut self,
            request: impl tonic::IntoRequest<super::IsHolidayRequest>,
        ) -> std::result::Result<
            tonic::Response<super::IsHolidayResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/rpc_datetime.HolidayService/IsHoliday",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("rpc_datetime.HolidayService", "IsHoliday"));
...
pub mod holiday_service_server {
    ...
    pub trait HolidayService: Send + Sync + 'static {
        async fn is_holiday(
            &self,
            request: tonic::Request<super::IsHolidayRequest>,
        ) -> std::result::Result<
            tonic::Response<super::IsHolidayResponse>,
            tonic::Status,
        >;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/rpc_datetime.HolidayService/IsHoliday" => {
                    ...
                    struct IsHolidaySvc<T: HolidayService>(pub Arc<T>);
                    impl<
                        T: HolidayService,
                    > tonic::server::UnaryService<super::IsHolidayRequest>
                    for IsHolidaySvc<T> {
                        type Response = super::IsHolidayResponse;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as HolidayService>::is_holiday(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T: HolidayService> tonic::server::NamedService for HolidayServiceServer<T> {
        const NAME: &'static str = "rpc_datetime.HolidayService";
    }
}
